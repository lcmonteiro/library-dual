/// @file multiplies.hpp
/// @brief Defines multiplication operations for dual numbers, including derivative computations,
///        element-wise array multiplication, and broadcasting.
...
namespace dual
{
  /// @brief Binary functor for multiplication and its derivatives for dual numbers.
  struct multiplies : binary_operation<multiplies>
  {
    ...
    /// @brief Computes the derivative of the multiplication for a scalar and a dual number.
    /// @tparam T Numeric type.
    ...
    /// @brief Computes the derivative of the multiplication for a dual number and a scalar.
    /// @tparam T Numeric type.
  ...
  /// @brief Overloads the multiplication operator for element-wise array multiplication.
  ...
  /// @brief Functor for broadcasting multiplication operation between arrays and scalars.
  ...
  /// @brief Overloads the multiplication operator for broadcasting multiplication between arrays and scalars.
