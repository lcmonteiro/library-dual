/// @file plus.hpp
/// @brief Defines addition operations for dual numbers, including derivative computations,
///        element-wise array addition, and broadcasting.
...
namespace dual
{
  ...
  struct plus : binary_operation<plus>
  {
    ...
    /// @brief Computes the derivative for addition where only the second operand is dual.
    /// @tparam T Numeric type.
    ...
    /// @brief Computes the derivative for addition where only the first operand is dual.
    /// @tparam T Numeric type.
    /// @param n1 First dual value and derivative.
  ...
  /// @brief Functor for broadcasting addition operation between arrays and scalars.
  ...
  /// @brief Overloads the addition operator for broadcasting addition between arrays and scalars.
