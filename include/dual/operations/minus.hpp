/// @file minus.hpp
/// @brief Defines subtraction operations for dual numbers, including derivative computations,
///        element-wise array subtraction, and broadcasting.
...
namespace dual
{
  ...
  struct minus : binary_operation<minus>
  {
    ...
    /// @brief Computes the derivative for subtraction where only the subtrahend is dual.
    /// @tparam T Numeric type.
    ...
    /// @brief Computes the derivative for subtraction where only the minuend is dual.
    /// @tparam T Numeric type.
    /// @param n1 Minuend dual value and derivative.
  ...
  /// @brief Overloads the subtraction operator for element-wise array subtraction.
  ...
  /// @brief Functor for broadcasting subtraction operation between arrays and scalars.
  ...
  /// @brief Overloads the subtraction operator for broadcasting subtraction between arrays and scalars.
