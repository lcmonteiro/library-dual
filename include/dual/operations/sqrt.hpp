/// @file sqrt.hpp
/// @brief Defines square root operations for dual numbers, including derivative computations
...
namespace dual
{
  /// @brief Functor for computing square root and its derivative for dual numbers.
...
namespace std
{
  ...
  /// @return An array with each element as the square root of the original element.
