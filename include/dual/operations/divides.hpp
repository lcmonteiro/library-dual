/// @file divides.hpp
/// @brief Defines division operations for dual numbers, including derivative computations,
...
namespace dual
{
  ...
  struct divides : binary_operation<divides>
  {
    ...
    /// @brief Computes the derivative of the division for a scalar numerator and dual denominator.
    /// @tparam T Numeric type.
    ...
    /// @brief Computes the derivative of the division for a dual numerator and scalar denominator.
    /// @tparam T Numeric type.
    /// @param n1 Numerator dual value and derivative.
  ...
  /// @brief Functor for broadcasting division operation between arrays and scalars.
  ...
  /// @brief Overloads the division operator for broadcasting division between arrays and scalars.
