/// @file zip.hpp
/// @brief Provides utilities to zip multiple containers or tuples together, element-wise,
///        producing tuples of corresponding elements from each container.
...
namespace dual
{
  ...
  /// @brief Zips the elements at specified indices from each container into tuples.
  /// @tparam Is Indices to zip.
  /// @tparam Ts Types of the containers.
  /// @param idx Indices to select.
  /// @param containers The containers to zip.
  /// @return A tuple containing tuples of the selected elements from each container.
  ...
  ///        The result contains tuples where each tuple holds the elements from each container at the same index.
  ///        The number of tuples is determined by the smallest container size.
  /// @tparam Ts Types of the containers.
  /// @param containers The containers to zip.
  /// @return A tuple containing tuples of corresponding elements from each container.
  template <class... Ts>
  constexpr auto zip(const Ts &... containers)
  {
