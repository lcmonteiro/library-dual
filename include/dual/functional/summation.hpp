/// @file summation.hpp
/// @brief Provides utilities to compute the sum of applying a predicate to each element of a tuple
///        or dual::array.
...
namespace dual
{
  ...
  /// @brief Computes the sum of applying a predicate to each element of a std::tuple.
  ...
  /// @brief Computes the sum of applying a predicate to each element of a dual::array.
  /// @tparam F Type of the predicate/function to apply.
