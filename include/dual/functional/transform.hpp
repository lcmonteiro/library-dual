/// @file transform.hpp
/// @brief Provides utilities to transform elements of dual::array and std::array using a predicate.
...
namespace dual
{
  ...
  /// @brief Applies a predicate to each element of a dual::array, returning a new dual::array.
  ...
  /// @brief Applies a predicate to each element of a std::array, returning a new std::array.
  /// @tparam F Type of the predicate/function to apply.
