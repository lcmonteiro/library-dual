...
struct number {
  ...
  constexpr explicit number(const T &init) : value_{init}, dvalues_{} {}
  ...
  constexpr explicit number(const T &value, const T dvalue)
      : value_{value}, dvalues_{{dvalue_type<Dn>{dvalue}...}} {}
  ...
  constexpr number(const number<T, Ds...> &other)
      : value_{other.value()}, dvalues_{} {
