/// @file print.hpp
/// @brief Provides print utilities for dual numbers, dual arrays, and standard containers.
///        Functions are overloaded to support various dual types and variadic printing.
...
namespace dual
{
  ...
  /// @brief Prints a dual::number, showing its value and the derivatives for each index.
  ...
  /// @brief Implementation: Prints a dual::number, showing value and all derivatives.
  template <class U, size_t... Is>
  inline auto print(const number<U, Is...> &n)
  {
    std::cout << n.value() << " [";
  ...
  /// @brief Implementation: Prints a dual::array by applying print to all storage elements.
  template <class... U>
  inline auto print(const array<U...> &data)
  {
  ...
  /// @brief Implementation: Prints a std::array by applying print to each element.
  template <class U, size_t N>
  inline auto print(const std::array<U, N> &data)
  {
